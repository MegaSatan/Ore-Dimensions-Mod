...
public class BiomeDecoratorCoal extends BiomeDecorator {
	
	// This predicate is used by WorldGen constructors to define
    // whether a block can be replaced by ore generation.
    Predicate<IBlockState> replaceablePredicate = new CoalPredicate();
    ...
    protected WorldGenFlowersCustom flowerGen;
    
    public BiomeDecoratorCoal() {
super();
    ...
    private void generateFlowers(World worldIn, Biome biomeIn, Random random, BlockPos chunkPos)
    {
        ...
        for (int numFlowersGenerated = 0; numFlowersGenerated < flowersPerChunk; ++numFlowersGenerated)
        {
            ...
            flowerGen = new WorldGenFlowersCustom();
    ...
    static class CoalPredicate implements Predicate<IBlockState>
    {
        private CoalPredicate()
        {
        }
        ...
        {
            if (parBlockState != null && parBlockState.getBlock() == Blocks.COAL_ORE.getDefaultState())
            {
                return true;
            }
            else
