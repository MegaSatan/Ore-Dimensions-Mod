...
public class ChunkGeneratorCoal implements IChunkGenerator{
    ...
    protected Biome biome = BiomeInit.COAL_DIMENSION;
    protected IBlockState baseBlock = Blocks.COAL_ORE.getDefaultState();
    ...
    public ChunkGeneratorCoal(World worldIn) {
    	System.out.println("Constructing ChunkGeneratorCoal");
