...
import mod.Mega_CS.oredim.world.biomes.BiomeProviderCoal;
...
public class WorldTypeCoal extends WorldType{

	public WorldTypeCoal() {
		super(DimensionInit.COAL_ORE_DIM.getName());
